...
| ----- | :-------------------------------------------------------------------------------------------------------------------------------------------------: |
| 01    |                                                             [Úvod](./readMe.md)                                                             |
| 02    |                                               [Typy dát](./02_Day_Data_types/02_day_data_types.md)                                                |
| 03    |                             [Booleovské hodnoty, Operátory, Dátum](./03_Day_Booleans_operators_date/03_booleans_operators_date.md)                             |
| 04    |                                            [Podmienky](./04_Day_Conditionals/04_day_conditionals.md)                                             |
| 05    |                                                     [Polia](./05_Day_Arrays/05_day_arrays.md)                                                      |
| 06    |                                                       [Opakovania](./06_Day_Loops/06_day_loops.md)                                                       |
| 07    |                                                 [Funkcie](./07_Day_Functions/07_day_functions.md)                                                 |
| 08    |                                                    [Objekty](./08_Day_Objects/08_day_objects.md)                                                    |
| 09    |                             [Vyššie rádové funkcie"](./09_Day_Higher_order_functions/09_day_higher_order_functions.md)                              |
| 10    |                                           [Sety a mapy](./10_Day_Sets_and_Maps/10_day_Sets_and_Maps.md)                                           |
| 11    |                      [Destruktúrovanie a rozširovanie](./11_Day_Destructuring_and_spreading/11_day_destructuring_and_spreading.md)                      |
| 12    |                                  [Regulárne výrazy](./12_Day_Regular_expressions/12_day_regular_expressions.md)                                  |
| 13    |                             [Metódy objektu Konzola](./13_Day_Console_object_methods/13_day_console_object_methods.md)                              |
| 14    |                                         [Spracovanie chýb](./14_Day_Error_handling/14_day_error_handling.md)                                          |
| 15    |                                                    [Rozhrania](./15_Day_Classes/15_day_classes.md)                                                    |
| 16    |                                                        [JSON](./16_Day_JSON/16_day_json.md)                                                         |
| 17    |                                            [Webové úložiská](./17_Day_Web_storages/17_day_web_storages.md)                                             |
